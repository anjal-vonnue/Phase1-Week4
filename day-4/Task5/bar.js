...
function findAverage(sales, number) {
  let average = 0;
  sales.forEach((sale) => {
...
const averageTarget = findAverage(sales, 12);
...
function animate(currentTime) {
  ...
  if (progress >= 1) {
    ...
    ctx.fillText(`Average: ${averageTarget}`, 80, targetY - 8);
  }
