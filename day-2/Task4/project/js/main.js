...
performance.mark("project-init-start");
...
performance.mark("project-init-end");

const initMeasure = performance.measure(
  "project-init",
  "project-init-start",
  "project-init-end",
);

console.log("performance measure: ", initMeasure.duration);
...
function checkConnection() {
  ...
  console.log(typeof navigator.connection.effectiveType);
